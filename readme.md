...
## Usage
Please see [godoc.org](http://godoc.org/github.com/yongping/gatt_edison) for documentation.
...
Please check [#32](https://github.com/yongping/gatt_edison/issues/32) for the status of this issue.
